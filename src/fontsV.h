...
const uint8_t fontVar[][6] PROGMEM = {
	...
	{0x50, 0x30, 0x00, 0x00, 0x00, 0x82}, // , 0x2c 44 12
	...
	{0x56, 0x36, 0x00, 0x00, 0x00, 0x83}, // ; 0x3b 59 27
	...
	{0x7f, 0x49, 0x49, 0x49, 0x41, 0x85}, // E 0x45 69 37
	{0x7f, 0x09, 0x09, 0x09, 0x01, 0x85}, // F 0x46 70 38
	...
	{0x7f, 0x40, 0x40, 0x40, 0x40, 0x85}, // L 0x4c 76 44
	...
	{0x00, 0x7f, 0x41, 0x00, 0x00, 0x83}, // [ 0x5b 91 59
	{0x02, 0x04, 0x08, 0x10, 0x20, 0x85}, // \ 0x5c 92 60
	{0x41, 0x7f, 0x00, 0x00, 0x00, 0x83}, // ] 0x5d 93 61
	...
	{0x7f, 0x48, 0x44, 0x38, 0x44, 0x84}, // b 0x62 98 66
	{0x38, 0x44, 0x44, 0x28, 0x20, 0x84}, // c 0x63 99 67
	{0x38, 0x44, 0x48, 0x7f, 0x44, 0x84}, // d 0x64 100 68
	{0x38, 0x54, 0x54, 0x18, 0x54, 0x84}, // e 0x65 101 69
	{0x08, 0x7e, 0x09, 0x01, 0x02, 0x84}, // f 0x66 102 70
	{0x18, 0xA4, 0x94, 0x7C, 0xA4, 0x84}, // g 0x67 103 71
	{0x7f, 0x08, 0x04, 0x78, 0x04, 0x84}, // h 0x68 104 72
	{0x44, 0x7d, 0x40, 0x00, 0x00, 0x83}, // i 0x69 105 73
	{0x40, 0x80, 0x84, 0x7D, 0x00, 0x84}, // j 0x6a 106 74
	{0x7f, 0x10, 0x28, 0x44, 0x00, 0x84}, // k 0x6b 107 75
	{0x41, 0x7f, 0x40, 0x00, 0x00, 0x83}, // l 0x6c 108 76
	...
	{0x18, 0x24, 0x28, 0xFC, 0x24, 0x84}, // q 0x71 113 81
	{0x7c, 0x08, 0x04, 0x08, 0x00, 0x84}, // r 0x72 114 82
	{0x48, 0x54, 0x54, 0x24, 0x00, 0x84}, // s 0x73 115 83
	{0x04, 0x3f, 0x44, 0x40, 0x20, 0x84}, // t 0x74 116 84
	...
	{0x08, 0x36, 0x41, 0x41, 0x00, 0x84}, // { 0x7b 123 91
	{0x00, 0x7f, 0x00, 0x00, 0x00, 0x83}, // | 0x7c 124 92
	{0x41, 0x41, 0x36, 0x08, 0x00, 0x84}, // } 0x7d 125 93
	...
	{0x7F, 0x01, 0x01, 0x01, 0x01, 0x85}, // Г 98
	{0x60, 0x3E, 0x21, 0x3F, 0x60, 0x85}, // Д 99
	{0x7f, 0x49, 0x49, 0x49, 0x41, 0x85}, // Е 100
	{0x77, 0x08, 0x7F, 0x08, 0x77, 0x85}, // Ж 101
	{0x22, 0x41, 0x49, 0x49, 0x36, 0x85}, // З 102
	...
	{0x47, 0x48, 0x28, 0x18, 0x07, 0x85}, // У 114
	...
	{0x7c, 0x04, 0x04, 0x04, 0x04, 0x84}, // г 130
	...
	{0x7c, 0x20, 0x10, 0x08, 0x7c, 0x85}, // и 135
	{0x7c, 0x41, 0x22, 0x11, 0x7c, 0x85}, // й 136
	...
	{0x38, 0x44, 0x44, 0x44, 0x40, 0x84}, // c 144
	{0x04, 0x04, 0x7c, 0x04, 0x04, 0x85}, // т 145
	...
	{0x38, 0x54, 0x44, 0x28, 0x44, 0x84}, // є 0xd194 165
	{0x4C, 0x54, 0x64, 0x00, 0x00, 0x83}, // s 0xd195 166
	{0x44, 0x7D, 0x40, 0x00, 0x00, 0x83}, // i 0xd196 167
	{0x45, 0x7c, 0x45, 0x00, 0x00, 0x83}, // ї 0xd197 168
