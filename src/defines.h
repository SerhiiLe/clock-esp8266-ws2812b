...
// #define USE_FastLED 1 // использовать FastLED библиотеку на светодиодную матрицу или GyverOLED для тестирования
#define USE_FTP 1 // использовать FTP доступ к внутренней памяти. Облегчает тестирование
