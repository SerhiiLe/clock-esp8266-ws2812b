...
uint16_t br_boost = 100; // усиление показателей датчика яркости в процентах (1-250)
...
uint8_t timeout_mp3 = 36; // таймаут до принудительного сброса модуля mp3
uint8_t sync_time_period = 8; // периодичность синхронизации ntp в минутах
